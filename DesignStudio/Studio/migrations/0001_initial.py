# Generated by Django 4.2.5 on 2023-11-07 03:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('design', models.ImageField(help_text='Разрешается формата файла только jpg, jpeg, png, bmp', max_length=254, upload_to='media/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png', 'bmp'])], verbose_name='Дизайн')),
                ('comment', models.TextField(max_length=1000, verbose_name='Комментарий')),
                ('date_create', models.DateField(default=datetime.datetime.now, verbose_name='Дата создания')),
                ('time_create', models.TimeField(default=datetime.datetime.now, verbose_name='Время создания')),
